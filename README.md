...
**A PHP + MySQL factory management system with a fully structured relational schema, CRUD dashboards, and ER diagrams.**
...
## Repository Description (Attractive Summary)
